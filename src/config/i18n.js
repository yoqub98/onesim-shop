...
export const TRANSLATIONS = {
  ru: {
    ...
    packagePage: {
      ...
      compatibilityModal: {
        heading: 'Перед покупкой убедитесь, что ваше устройство поддерживает eSIM',
        dialPrefix: 'Наберите на телефоне ',
        dialCode: '*#06#',
        dialSuffix: ' и проверьте, отображается ли EID',
        eidConfirm: 'Если EID есть, устройство поддерживает eSIM',
        recommendation: 'Рекомендуем проверить это перед продолжением покупки',
        cancel: 'Отменить',
        continue: 'ПРОДОЛЖИТЬ',
        continueSubtext: 'Устройство поддерживает esim',
      },
    },
    plansPage: {
    ...
    myPage: {
     ...
     orders: {
        ...
        notReloadable: 'Не пополняемый',
        detailsTab: 'Детали',
        actionsTab: 'Действия',
        actionsLoading: 'Загрузка истории действий...',
        actionsError: 'Не удалось загрузить историю действий',
      ...
      topup: {
        title: 'Пополнение eSIM',
        selectPlan: 'Выберите пакет для пополнения',
        availablePlans: 'Доступные пакеты для пополнения',
        selectedPlan: 'Выбранный пакет',
        confirmTitle: 'Подтвердите пополнение',
        confirmMessage: 'Вы уверены, что хотите пополнить этот eSIM пакетом',
        for: 'за',
        dataAdded: 'Будет добавлено данных',
        daysAdded: 'Будет добавлено дней',
        currentUsage: 'Текущее использование',
        topupCount: 'Количество пополнений',
        maxTopupsReached: 'Достигнут максимум пополнений (10/10)',
        processing: 'Обработка пополнения...',
        success: 'Пополнение успешно!',
        successMessage: 'Ваш eSIM успешно пополнен',
        failed: 'Ошибка пополнения',
        close: 'Закрыть',
        confirm: 'Подтвердить',
        cancel: 'Отмена',
        loading: 'Загрузка...',
        noPlansAvailable: 'Нет доступных пакетов для пополнения',
        notSupported: 'Этот пакет не поддерживает пополнение',
      },
      actions: {
 ...
 esimStatus: {
  ...
  uz: {
    ...
    packagePage: {
      ...
      compatibilityModal: {
        heading: 'Xarid qilishdan oldin qurilmangiz eSIM qo\'llab-quvvatlashini tekshiring',
        dialPrefix: 'Telefonda ',
        dialCode: '*#06#',
        dialSuffix: ' teriring va EID ko\'rsatilayotganini tekshiring',
        eidConfirm: 'Agar EID bo\'lsa, qurilma eSIM qo\'llab-quvvatlaydi',
        recommendation: 'Xaridni davom ettirishdan oldin buni tekshirishni tavsiya qilamiz',
        cancel: 'Bekor qilish',
        continue: 'DAVOM ETISH',
        continueSubtext: 'Qurilma esim qo\'llab-quvvatlaydi',
      },
    },
    plansPage: {
    ...
    myPage: {
      ...
      orders: {
        ...
        notReloadable: 'To\'ldirib bo\'lmaydigan',
        detailsTab: 'Tafsilotlar',
        actionsTab: 'Harakatlar',
        actionsLoading: 'Harakatlar tarixi yuklanmoqda...',
        actionsError: 'Harakatlar tarixini yuklab bo\'lmadi',
        actionsEmpty: 'Hozircha harakatlar yo\'q',
        actions: {
          package: 'Paket',
          paid: 'To\'langan',
          added: 'Qo\'shildi',
        ...
        actionTypes: {
          orderPlaced: 'Paket sotib olindi',
          activated: 'Paket faollashtirildi',
          topup: 'To\'ldirish',
          cancel: 'Bekor qilish',
          suspend: 'To\'xtatildi',
          resume: 'Qayta tiklandi',
          revoke: 'Bekor qilindi',
          unknown: 'Harakat',
        },
      },
      topup: {
        title: 'eSIM to\'ldirish',
        selectPlan: 'To\'ldirish uchun paketni tanlang',
        availablePlans: 'To\'ldirish uchun mavjud paketlar',
        selectedPlan: 'Tanlangan paket',
        confirmTitle: 'To\'ldirishni tasdiqlang',
        confirmMessage: 'Ushbu eSIM-ni quyidagi paket bilan to\'ldirishni xohlaysizmi',
        for: 'uchun',
        dataAdded: 'Qo\'shiladi (ma\'lumot)',
        daysAdded: 'Qo\'shiladi (kunlar)',
        currentUsage: 'Joriy foydalanish',
        topupCount: 'To\'ldirishlar soni',
        maxTopupsReached: 'Maksimal to\'ldirishlar soniga erishildi (10/10)',
        processing: 'To\'ldirish qayta ishlanmoqda...',
        success: 'Muvaffaqiyatli to\'ldirildi!',
        successMessage: 'Sizning eSIM muvaffaqiyatli to\'ldirildi',
        failed: 'To\'ldirish xatosi',
        close: 'Yopish',
        confirm: 'Tasdiqlash',
        cancel: 'Bekor qilish',
        loading: 'Yuklanmoqda...',
        noPlansAvailable: 'To\'ldirish uchun mavjud paketlar yo\'q',
        notSupported: 'Bu paket to\'ldirishni qo\'llab-quvvatlamaydi',
      },
  esimStatus: {
      // Order statuses (internal database statuses)
