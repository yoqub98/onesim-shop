    ...
    myPage: {
     ...
     orders: {
      ...
      qrModal: {
        ...
        quickInstallIOS: 'Быстрая установка (iOS)',
        quickInstallAndroid: 'Быстрая установка (Android)',
        quickInstallIOSHelper: 'Требуется iOS 17.4 или выше',
        quickInstallAndroidHelper: 'Требуется Android 10 или выше',
        smdpAddress: 'SM-DP+ адрес:',
        instructions: 'Откройте настройки телефона, перейдите в раздел "Сотовая связь" и отсканируйте QR-код или используйте кнопки быстрой установки выше для автоматической установки eSIM.',
        share: 'Поделиться',
        close: 'Закрыть',
      },
      cancelModal: {
 ...
 esimStatus: {
  ...
  esimStatus: {
      ...
      qrModal: {
        ...
        quickInstallIOS: 'Tezkor o\'rnatish (iOS)',
        quickInstallAndroid: 'Tezkor o\'rnatish (Android)',
        quickInstallIOSHelper: 'iOS 17.4 yoki undan yuqori talab qilinadi',
        quickInstallAndroidHelper: 'Android 10 yoki undan yuqori talab qilinadi',
        smdpAddress: 'SM-DP+ manzil:',
        instructions: 'Telefon sozlamalarini oching, "Uyali aloqa" bo\'limiga o\'ting va QR-kodni skanerlang yoki yuqoridagi tezkor o\'rnatish tugmalaridan foydalaning.',
        share: 'Ulashish',
        close: 'Yopish',
      },
      cancelModal: {
